...
export default function TranscriptSummary({
  ...
  const ordered = useMemo(() => [...chunks].sort((a, b) => a.timestamp.localeCompare(b.timestamp)), [chunks])
  ...
  useEffect(() => {
    if (ordered.length === 0 || !shouldAutoScrollRef.current) return
    ...
    <div className="flex min-h-0 flex-1 flex-col gap-4">
      ...
      <section className="dash-card flex min-h-0 flex-1 flex-col" aria-label="911 phone call transcript">
        ...
        <div
          ...
          className="min-h-0 max-h-[500px] flex-1 overflow-y-auto p-4"
        >
